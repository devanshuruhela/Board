...
function SideNavbar() {
  return (
    <div>
      <Disclosure as="nav">
        <Disclosure.Button className="absolute inline-flex items-center justify-center p-2 text-gray-800 rounded-md top-3 left-3 peer hover:bg-gray-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white group">
          <GiHamburgerMenu
        ...
        <div className="fixed top-0 z-20 w-1/2 min-h-fit pl-2 pt-5 pr-5 my-10 ml-10 mr-1 duration-200 ease-out delay-150 bg-black -left-96 lg:left-0 lg:w-60 peer-focus:left-0 peer:transition  rounded-[30px]">
