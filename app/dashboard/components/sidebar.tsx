  ...
  return (
    <div>
      <Disclosure as="nav">
        ...
        <div className="fixed top-0 z-20 w-1/2 h-[90vh] pl-5 pt-5 pr-10 m-10 duration-200 ease-out delay-150 bg-black -left-96 lg:left-0 lg:w-60 peer-focus:left-0 peer:transition  rounded-[30px]">
          ...
          <div className="flex flex-col justify-start item-center">
            ...
            <div className="pb-4 my-4 ">
              <div className="flex items-center justify-start gap-4 p-2 pl-5 m-auto mb-2 rounded-md cursor-pointer hover:bg-white group hover:shadow-lg">
                ...
                <h3 className="text-[16px] font-semibold text-white group-hover:text-black ">
                  Dashboard
                </h3>
              </div>
              <div className="flex items-center justify-start gap-4 p-2 pl-5 m-auto mb-2 rounded-md cursor-pointer hover:bg-white group hover:shadow-lg">
